...
export default function HeroSection() {
  return (
    <section className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden bg-background">
      ...
      <div className="absolute inset-0 z-1 bg-[radial-gradient(ellipse_80%_60%_at_50%_50%,rgba(11,17,14,0.75)_0%,rgba(11,17,14,0.75)_60%,rgba(11,17,14,0.95)_100%)]" />
      ...
      <div className="relative z-10 container text-center">
        ...
        {/* Subtext */}
        <p className="animate-fade-up delay-200 mx-auto text-slate-300 font-body text-[clamp(1rem,2vw,1.2rem)] leading-[1.7] max-w-[600px] mb-10">
        ...
        {/* Trust indicators */}
        <div className="flex flex-wrap justify-center gap-6 mt-12 animate-fade-up delay-400 text-slate-400 text-[0.8rem] font-mono">
      ...
      {/* Bottom fade */}
      <div className="absolute bottom-0 left-0 right-0 h-32 z-2 bg-[linear-gradient(to_bottom,oklch(0.09_0.012_160_/_0),oklch(0.09_0.012_160))]" />

      {/* Scroll indicator */}
      <div className="absolute bottom-8 left-1/2 -translate-x-1/2 z-10 animate-fade-up delay-600 text-slate-400">
