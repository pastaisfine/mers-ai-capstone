...
export function OperationsTab() {
  ...
  return (
    <div className="relative flex h-full min-h-0 flex-1 flex-col overflow-hidden">
      ...
      <div className="grid min-h-0 flex-1 grid-cols-1 grid-rows-[auto_1fr] overflow-hidden md:grid-cols-[minmax(220px,22%)_1fr] md:grid-rows-1 lg:grid-cols-[minmax(240px,22%)_1fr_minmax(280px,28%)]">
        <IncidentList />
